...
(function() {
    ...
    onDocumentReady(() => {
        ...
        const 서가번호표 = [
            ...
            { 별치기호: '아동', 시작번호: '320-1', 끝번호: '342.1-999', 서가번호: '어린이자료실2(2층)-J' },
            { 별치기호: '아동', 시작번호: '342.11', 끝번호: '399.999', 서가번호: '어린이자료실2(2층)-I' },
            { 별치기호: '아동', 시작번호: '400-1-1', 끝번호: '408-3-49', 서가번호: '어린이자료실2(2층)-16' },
            { 별치기호: '아동', 시작번호: '408-3-50', 끝번호: '410-10-10', 서가번호: '어린이자료실2(2층)-17' },
            { 별치기호: '아동', 시작번호: '410-11-1', 끝번호: '451-5', 서가번호: '어린이자료실2(2층)-18' },
            { 별치기호: '아동', 시작번호: '451-6', 끝번호: '499.999', 서가번호: '어린이자료실2(2층)-19' },
            { 별치기호: '아동', 시작번호: '500-1', 끝번호: '599.999', 서가번호: '어린이자료실2(2층)-20' },
            { 별치기호: '아동', 시작번호: '600-1', 끝번호: '799.999', 서가번호: '어린이자료실2(2층)-H' },
            { 별치기호: '아동', 시작번호: '800-1', 끝번호: '808.3-9-210', 서가번호: '어린이자료실2(2층)-D' },
            { 별치기호: '아동', 시작번호: '808.3-9-211', 끝번호: '811.8-245', 서가번호: '어린이자료실2(2층)-10' },
            { 별치기호: '아동', 시작번호: '811.8-246', 끝번호: '813.8-1343', 서가번호: '어린이자료실2(2층)-11' },
            { 별치기호: '아동', 시작번호: '813.8-2861', 끝번호: '833.8-206', 서가번호: '어린이자료실2(2층)-13' },
            { 별치기호: '아동', 시작번호: '813.8-1344', 끝번호: '813.8-2860', 서가번호: '어린이자료실2(2층)-12' },
            { 별치기호: '아동', 시작번호: '833.8-207-1', 끝번호: '843-520', 서가번호: '어린이자료실2(2층)-14' },
            ...
            { 별치기호: '아동영어', 시작번호: '744-1', 끝번호: '843-155', 서가번호: '어린이자료실1(1층)-03' },
            { 별치기호: '아동영어', 시작번호: '843-341', 끝번호: '999.999', 서가번호: '어린이자료실1(1층)-05' },
            { 별치기호: '아동영어', 시작번호: '843-156', 끝번호: '843-340', 서가번호: '어린이자료실1(1층)-04' },
